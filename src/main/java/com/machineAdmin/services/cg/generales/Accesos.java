...
public class Accesos {
     ...
     *
     * @param content debera contener la cadena cifrada con el identificador del usuario en el atributo nombre y contra a logear en formato json, EJ: {"nombre":"Administrador", "contra":"1234"}, seria: SEMZhVpciiV6VyKO4MwpMu92YiYlPoxMTz1ivHKhrKOtw5/2AXSoO/OZE3qmMDQ15C/Mxz9AsO1KbpH92Ov7+s58YnjmvNo+WhSAflsmXLBlYLaSZ9i3Wab9atsAC9+3Sh3it/qqFeyWDicyHVh3Au2d9j9sMGvzb2lM8ygiL+0=
     * @return en data: el usuario logeado, en metadata: el token de sesion
     */
    @POST
    @Path("/iniciarSesion")
    public ModelUsuarioLogeado login(ModelContenidoCifrado content) throws Exception {
