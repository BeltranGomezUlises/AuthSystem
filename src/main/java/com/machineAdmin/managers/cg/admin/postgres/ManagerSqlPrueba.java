...
import com.machineAdmin.daos.cg.admin.postgres.DaoSqlPrueba;
 ...
 */
public class ManagerSqlPrueba extends ManagerSQLCatalog<SqlPrueba, Integer>{

    public ManagerSqlPrueba() {
        super(new DaoSqlPrueba());
    }
